...
from admin.models import SessionStore as AdminSessionStore
...
class SessionMiddlewareInstance:
    ...
    async def __call__(self, receive, send):
        ...
        if self.scope['path'] == '/chat':
            self.middleware.session_store = SessionStore
        else:
            self.middleware.session_store = AdminSessionStore
